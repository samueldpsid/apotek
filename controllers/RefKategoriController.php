...
use app\models\search\RefKategoriSearch;
...
class RefKategoriController extends Controller
{
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    ...
                    'title'=> "Tambah Kategori Baru",
                    'content'=>'<span class="text-success">Tambah Kategori Berhasil</span>',
                    'footer'=> Html::button('Tutup',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
                            Html::a('Tambah Baru',['create'],['class'=>'btn btn-primary','role'=>'modal-remote'])
    ...
    /**
     * Delete an existing RefKategori model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing RefKategori model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
    ...
    {
        if (($model = RefKategori::findOne($id)) !== null) {
            return $model;
        } else {
